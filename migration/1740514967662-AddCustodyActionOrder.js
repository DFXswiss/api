...
module.exports = class AddCustodyActionOrder1740514967662 {
    name = 'AddCustodyActionOrder1740514967662'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "custody_action_order" ("id" int NOT NULL IDENTITY(1,1), "updated" datetime2 NOT NULL CONSTRAINT "DF_23891f76140b50512faa5c57b47" DEFAULT getdate(), "created" datetime2 NOT NULL CONSTRAINT "DF_2a57d45fb064c48bfc1279a3a64" DEFAULT getdate(), "type" nvarchar(255) NOT NULL, "userConfirmation" bit NOT NULL CONSTRAINT "DF_486735f08a1cacb1ec0f7a3e4ef" DEFAULT 0, "internalConfirmation" bit NOT NULL CONSTRAINT "DF_e93a163da9c9754efc33ec1533d" DEFAULT 0, "userId" int NOT NULL, CONSTRAINT "PK_6376f890b7362db01f58d9a57b4" PRIMARY KEY ("id"))`);
