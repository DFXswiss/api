module.exports = class RenameArkToArkade1775233148000 {
  ...
  async up(queryRunner) {
    await queryRunner.query(`UPDATE "dbo"."asset" SET "blockchain" = 'Arkade', "uniqueName" = REPLACE("uniqueName", 'Ark/', 'Arkade/'), "description" = 'Arkade' WHERE "blockchain" = 'Ark'`);
  ...
  async down(queryRunner) {
    await queryRunner.query(`UPDATE "dbo"."asset" SET "blockchain" = 'Ark', "uniqueName" = REPLACE("uniqueName", 'Arkade/', 'Ark/'), "description" = 'Ark' WHERE "blockchain" = 'Arkade'`);
