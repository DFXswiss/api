...
module.exports = class AddFiatOutput1668861354398 {
    name = 'AddFiatOutput1668861354398'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "fiat_output" ("id" int NOT NULL IDENTITY(1,1), "updated" datetime2 NOT NULL CONSTRAINT "DF_143e2cf41873a241bfe7ebf1040" DEFAULT getdate(), "created" datetime2 NOT NULL CONSTRAINT "DF_8bde4905c96434aeabda03651f2" DEFAULT getdate(), "type" nvarchar(256) NOT NULL, CONSTRAINT "PK_e7c5644857052228326a634b4f3" PRIMARY KEY ("id"))`);
