// FinancialDataLog entries created between 2026-07-02 and 2026-07-04 carry a
// totalBalanceChf that is implausibly high (> 20 000 CHF) compared to the expected
...
//
// Threshold : totalBalanceChf > 20 000.
// Scope     : entries created from 2026-07-02 through 2026-07-04 (UTC), i.e.
//             created >= 2026-07-02T00:00:00Z AND created < 2026-07-05T00:00:00Z, no
...
module.exports = class InvalidateHighTotalBalanceLogs1783123855813 {
  name = 'InvalidateHighTotalBalanceLogs1783123855813';

  async up(queryRunner) {
    const [{ count }] = await queryRunner.query(`
      SELECT COUNT(*) AS count FROM log
      WHERE  subsystem = 'FinancialDataLog'
        AND  created  >= '2026-07-02T00:00:00Z'
        AND  created  <  '2026-07-05T00:00:00Z'
        AND  (message::jsonb -> 'balancesTotal' ->> 'totalBalanceChf')::numeric > 20000
        AND  valid = true
    `);
