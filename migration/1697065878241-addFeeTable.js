...
module.exports = class addFeeTable1697065878241 {
    name = 'addFeeTable1697065878241'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "dbo"."user_data" ADD "discounts" nvarchar(256)`);
    }

    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "dbo"."user_data" DROP COLUMN "discounts"`);
