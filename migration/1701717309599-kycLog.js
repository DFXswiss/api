...
module.exports = class kycLog1701717309599 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "dbo"."kyc_log" ADD CONSTRAINT "FK_0b0568192de90bc31d61a3cf364" FOREIGN KEY ("kycStepId") REFERENCES "sqldb-dfx-api-dev".."kyc_step"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
