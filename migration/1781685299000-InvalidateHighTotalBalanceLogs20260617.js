// FinancialDataLog entries created on 2026-06-17 carry a totalBalanceChf that is
...
// 1781527084203) and 2026-06-16 (see InvalidateHighTotalBalanceLogs 1781598468039):
// plusBalanceChf jumped ahead of the corresponding minusBalanceChf booking, so
// deltas at the elevated baseline stayed within financeLogTotalBalanceChangeLimit
// and the invalid flag was never set. This migration marks those entries invalid so
...
// Scope     : entries created on 2026-06-17 (UTC), no upper bound so every
...
module.exports = class InvalidateHighTotalBalanceLogs1781685299000 {
  name = 'InvalidateHighTotalBalanceLogs1781685299000';
