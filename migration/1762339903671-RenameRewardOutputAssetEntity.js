...
module.exports = class RenameRewardOutputAssetEntity1762339903671 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "ref_reward" DROP COLUMN "outputAssetString"`);
        await queryRunner.query(`EXEC sp_rename "staking_reward.outputAssetEntityId", "outputAssetId"`);
        await queryRunner.query(`ALTER TABLE "staking_reward" DROP COLUMN "outputAssetString"`);
        await queryRunner.query(`EXEC sp_rename "staking_ref_reward.outputAssetEntityId", "outputAssetId"`);
        await queryRunner.query(`ALTER TABLE "staking_ref_reward" DROP COLUMN "outputAssetString"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "staking_ref_reward" ADD "outputAssetString" nvarchar(256)`);
        await queryRunner.query(`EXEC sp_rename "staking_ref_reward.outputAssetId", "outputAssetEntityId"`);
        await queryRunner.query(`ALTER TABLE "staking_reward" ADD "outputAssetString" nvarchar(256)`);
        await queryRunner.query(`EXEC sp_rename "staking_reward.outputAssetId", "outputAssetEntityId"`);
        await queryRunner.query(`ALTER TABLE "ref_reward" ADD "outputAssetString" nvarchar(256)`);
