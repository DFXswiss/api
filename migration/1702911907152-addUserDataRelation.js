...
module.exports = class addUserDataRelation1702911907152 {
    name = 'addUserDataRelation1702911907152'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "user_data_relation" ("id" int NOT NULL IDENTITY(1,1), "updated" datetime2 NOT NULL CONSTRAINT "DF_7c114d731acdf975ea3bef258e6" DEFAULT getdate(), "created" datetime2 NOT NULL CONSTRAINT "DF_2051f287b9f8bda8830f8c8d3e9" DEFAULT getdate(), "relation" nvarchar(256) NOT NULL, "signatory" nvarchar(256) NOT NULL, "accountId" int NOT NULL, "relatedAccountId" int NOT NULL, CONSTRAINT "PK_ff56997cdfa55669c94fde48735" PRIMARY KEY ("id"))`);
