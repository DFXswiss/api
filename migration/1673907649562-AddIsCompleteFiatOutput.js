...
module.exports = class AddIsCompleteFiatOutput1673907649562 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "fiat_output" ALTER COLUMN "batchAmount" float`);
    }

    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "fiat_output" ALTER COLUMN "batchAmount" int`);
