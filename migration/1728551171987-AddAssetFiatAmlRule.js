...
module.exports = class AddAssetFiatAmlRule1728551171987 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "dbo"."asset" ADD "amlRule" int CONSTRAINT "DF_cf9639865503f5add1847ceb23b" DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE "dbo"."fiat" ADD "amlRule" int CONSTRAINT "DF_314f15a0c0792a8efa07a3be936" DEFAULT 0`);
    }
