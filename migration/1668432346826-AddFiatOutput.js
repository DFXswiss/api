...
module.exports = class AddFiatOutput1668432346826 {
    name = 'AddFiatOutput1668432346826'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "buy_fiat" ADD "fiatOutputId" int NOT NULL`);
