...
module.exports = class buyCrypto1650799366623 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "buy_crypto" ("id" int NOT NULL IDENTITY(1,1), "updated" datetime2 NOT NULL CONSTRAINT "DF_ca289a5a40aa826752c24e5c756" DEFAULT getdate(), "created" datetime2 NOT NULL CONSTRAINT "DF_3d1a83c2a2fb1726ba6b655aa0b" DEFAULT getdate(), "inputAmount" float, "inputAsset" nvarchar(256), "inputReferenceAmount" float, "inputReferenceAsset" nvarchar(256), "amountInChf" float, "amountInEur" float, "amlCheck" nvarchar(256), "fee" float, "inputReferenceAmountMinusFee" float, "outputReferenceAmount" float, "outputReferenceAsset" nvarchar(256), "outputAmount" float, "outputAsset" nvarchar(256), "txId" nvarchar(256), "outputDate" datetime2, "recipientMail" nvarchar(256), "mailSendDate" float, "usedRef" nvarchar(256), "refProvision" float, "refFactor" float, "bankTxId" int NOT NULL, "buyId" int, CONSTRAINT "PK_f8243bf386aa594a1b176a54730" PRIMARY KEY ("id"))`);
