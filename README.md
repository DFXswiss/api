...
1. Create an address on selected blockchain (e.g. DeFiChain), see [example](#login-example) below
1. Get the sign message from [sign-message endpoint](https://api.dfx.swiss/swagger/#/Auth/AuthController_getSignMessage) and sign it with the corresponding private key
