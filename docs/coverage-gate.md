...
Of the 447 pinned files, **252 carry real logic** (they have functions and/or branches) and
**195 are purely declarative today** (NestJS modules, constant files with neither). The two groups
...
when one of the 195 purely declarative files (a NestJS module, a constants file) first gains
