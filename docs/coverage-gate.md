...
Of the 454 pinned files, **258 carry real logic** (they have functions and/or branches) and
**196 are purely declarative today** (NestJS modules, constant files with neither). The two groups
...
That rule stays hard for the 258 logic-carrying files. A foreseeable friction case is different:
when one of the 196 purely declarative files (a NestJS module, a constants file) first gains
