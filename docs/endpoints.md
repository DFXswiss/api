...
| POST | 1 |  | `/support/issue/:id/suggestion` | public | whole rows | 429 | not yet | yes | `SupportIssueController.createReplySuggestion` | `subdomains/supporting/support-issue/support-issue.controller.ts` |
