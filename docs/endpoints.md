...
| GET | 1 |  | `/support/pending-chargebacks` | hidden | whole rows | 669 | not yet |  | `SupportController.getPendingChargebacks` | `subdomains/generic/support/support.controller.ts` |
