...
Every place in the code that reads from the database: **at most 1169 load sites** across 252 files — an upper bound, for the reason given under *Measurements*.
...
| --------- | ----: | --------------- | ---------------- |
| `find` family | 1014 | **applied** — expanded recursively | all columns of the entity plus every eager relation |
...
| 422 | 14 | find | `SupportIssue` | `subdomains/supporting/support-issue/services/support-reply-suggestion.service.ts:36` | `SupportReplySuggestionService.createSuggestion` |
