...
Every place in the code that reads from the database: **at most 1169 load sites** across 251 files — an upper bound, for the reason given under *Measurements*.
...
| --------- | ----: | --------------- | ---------------- |
| `find` family | 1016 | **applied** — expanded recursively | all columns of the entity plus every eager relation |
...
- 368 could not be measured: no resolvable target entity, or raw SQL.

**That last group is also why the total is an upper bound.** The collection matches `find` by name, and `find` on a repository is indistinguishable by name from `find` on an array. Where the target entity resolved, the distinction is settled; where it did not, the group holds both. A sample of 30 of those rows, read in the source, came out at 21 array operations to 9 genuine repository reads. That group holds 349 rows, so on the order of 240 of them are not database reads at all, and the true count is nearer 900.
...
| 803 | 29 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:446` | `BuyFiatService.refundBuyFiat` |
...
| 644 | 22 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:420` | `BuyFiatService.getBuyFiat` |
| 644 | 22 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:424` | `BuyFiatService.triggerWebhookManual` |
...
| 623 | 20 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:719` | `BuyFiatService.getAllUserTransactions` |
...
| 577 | 18 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:567` | `BuyFiatService.resetAmlCheck` |
...
| 540 | 17 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:863` | `BuyFiatService.getByAmlReason` |
...
| 518 | 16 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:877` | `BuyFiatService.getPendingChargebacks` |
...
| 517 | 16 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:580` | `BuyFiatService.retriggerScorechain` |
...
| 392 | 14 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:739` | `BuyFiatService.getPendingTransactions` |
...
| 321 | 8 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:408` | `BuyFiatService.getBuyFiatByTransactionId` |
| 321 | 8 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:413` | `BuyFiatService.getBuyFiatsByTransactionIds` |
...
| 287 | 8 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:846` | `BuyFiatService.getTransactions` |
...
| 247 | 9 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:675` | `BuyFiatService.updateVolumes` |
...
| 201 | 5 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:648` | `BuyFiatService.manualPassAmlCheck` |
...
| 144 | 6 | find | `Sell` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:764` | `BuyFiatService.getSell` |
...
| 71 | 0 | query-builder (alias only) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:386` | `BuyFiatService.getBuyFiatByKey` |
...
| 3 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:778` | `BuyFiatService.updateSellVolume` |
...
| 2 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:821` | `BuyFiatService.getRefVolume` |
| 2 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:833` | `BuyFiatService.getPartnerFeeRefVolume` |
...
| 1 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:686` | `BuyFiatService.updateRefVolumes` |
| 1 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:703` | `BuyFiatService.getUserVolume` |
...
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:488` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:496` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:504` | `BuyFiatService.refundBuyFiatInternal` |
