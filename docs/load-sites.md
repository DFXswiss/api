...
Every place in the code that reads from the database: **at most 1175 load sites** across 251 files — an upper bound, for the reason given under *Measurements*.
...
| --------- | ----: | --------------- | ---------------- |
| `find` family | 1022 | **applied** — expanded recursively | all columns of the entity plus every eager relation |
...
- 374 could not be measured: no resolvable target entity, or raw SQL.

**That last group is also why the total is an upper bound.** The collection matches `find` by name, and `find` on a repository is indistinguishable by name from `find` on an array. Where the target entity resolved, the distinction is settled; where it did not, the group holds both. A sample of 30 of those rows, read in the source, came out at 21 array operations to 9 genuine repository reads. That group holds 355 rows, so on the order of 240 of them are not database reads at all, and the true count is nearer 900.
...
Median across measured sites: **98 columns**. At least 14 sites exceed 1000, 77 exceed 500 and 395 exceed 100 — "at least", because 455 of these measurements are lower bounds, and a resolved relation tree can only widen a query, never narrow it.
...
| 1033 | 40 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:208` | `BuyFiatService.update` |
...
| 826 | 27 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:284` | `TransactionService.getTransactionsWithoutUid` |
| 826 | 27 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:293` | `TransactionService.getTransactionsByUserDataId` |
...
| 803 | 29 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:492` | `BuyFiatService.refundBuyFiat` |
...
| 644 | 22 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:466` | `BuyFiatService.getBuyFiat` |
| 644 | 22 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:470` | `BuyFiatService.triggerWebhookManual` |
...
| 623 | 20 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:827` | `BuyFiatService.getAllUserTransactions` |
...
| 577 | 18 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:133` | `BuyFiatService.checkAmlResetTx` |
| 577 | 18 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:630` | `BuyFiatService.resetAmlCheck` |
...
| 540 | 17 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:971` | `BuyFiatService.getByAmlReason` |
...
| 518 | 16 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:985` | `BuyFiatService.getPendingChargebacks` |
...
| 517 | 16 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:643` | `BuyFiatService.retriggerScorechain` |
...
| 392 | 14 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:847` | `BuyFiatService.getPendingTransactions` |
...
| 362 | 11 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:532` | `TransactionService.getByAssetId` |
...
| 321 | 8 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:454` | `BuyFiatService.getBuyFiatByTransactionId` |
| 321 | 8 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:459` | `BuyFiatService.getBuyFiatsByTransactionIds` |
...
| 287 | 8 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:954` | `BuyFiatService.getTransactions` |
...
| 247 | 9 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:783` | `BuyFiatService.updateVolumes` |
...
| 201 | 5 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:756` | `BuyFiatService.manualPassAmlCheck` |
...
| 144 | 6 | find | `Sell` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:872` | `BuyFiatService.getSell` |
...
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:76` | `PayoutService.checkOrderCompletion` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:98` | `PayoutService.getRecentPayoutSentCorrelationIds` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:124` | `PayoutService.speedupTransaction` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:147` | `PayoutService.retryUncertainPayout` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:250` | `PayoutService.logUncertainOrdersSnapshot` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:263` | `PayoutService.getLatestOrderDate` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:276` | `PayoutService.checkPreparationCompletion` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:296` | `PayoutService.checkPayoutCompletion` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:319` | `PayoutService.prepareNewOrders` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:336` | `PayoutService.payoutOrders` |
| 123 | 3 | find | `PayoutOrder` | `subdomains/supporting/payout/services/payout.service.ts:353` | `PayoutService.processFailedOrders` |
...
| 98 | 2 | query-builder (no select) | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:469` | `TransactionService.getRefBonusCandidates` |
...
| 98 | 2 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:241` | `TransactionService.getTransactionById` |
| 98 | 2 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:246` | `TransactionService.getTransactionsByIds` |
| 98 | 2 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:254` | `TransactionService.getTransactionByUid` |
| 98 | 2 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:261` | `TransactionService.getTransactionByRequestId` |
| 98 | 2 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:268` | `TransactionService.getTransactionByRequestUid` |
| 98 | 2 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:276` | `TransactionService.getTransactionByExternalId` |
| 98 | 2 | find | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:280` | `TransactionService.getTransactionByCkoId` |
...
| 71 | 0 | query-builder (alias only) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:432` | `BuyFiatService.getBuyFiatByKey` |
...
| 20 | 0 | query-builder (alias only) | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:324` | `TransactionService.getTransactionList` |
| 20 | 0 | query-builder (alias only) | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:546` | `TransactionService.getTransactionByKey` |
...
| 3 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:886` | `BuyFiatService.updateSellVolume` |
...
| 2 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:929` | `BuyFiatService.getRefVolume` |
| 2 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:941` | `BuyFiatService.getPartnerFeeRefVolume` |
...
| 2 | 0 | query-builder (named columns) | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:455` | `TransactionService.getManualRefVolume` |
| 2 | 0 | query-builder (named columns) | `Transaction` | `subdomains/supporting/payment/services/transaction.service.ts:510` | `TransactionService.getAuditPeriodVolumes` |
...
| 1 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:794` | `BuyFiatService.updateRefVolumes` |
| 1 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:811` | `BuyFiatService.getUserVolume` |
...
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:233` | `BuyFiatService.update` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:299` | `BuyFiatService.update` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:368` | `BuyFiatService.triggerBuyFiatReturn` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:376` | `BuyFiatService.triggerBuyFiatReturn` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:537` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:545` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:553` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:561` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:674` | `BuyFiatService.resetAmlCheckInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:682` | `BuyFiatService.resetAmlCheckInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:690` | `BuyFiatService.resetAmlCheckInternal` |
...
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:314` | `PayInService.returnPayIn` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:360` | `PayInService.ignorePayIn` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:368` | `PayInService.retryUncertainSend` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:422` | `PayInService.updateFailedPayments` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:462` | `PayInService.forwardPayIns` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:508` | `PayInService.getUnconfirmedNextBlockPayIns` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:545` | `PayInService.checkOutputConfirmations` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:568` | `PayInService.checkReturnConfirmations` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:591` | `PayInService.returnPayIns` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:620` | `PayInService.processStrandedSendingPayIns` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:664` | `PayInService.checkInputConfirmations` |
...
| — | — | find | `—` | `subdomains/supporting/payment/services/transaction.service.ts:164` | `TransactionService.resume` |
| — | — | find | `—` | `subdomains/supporting/payment/services/transaction.service.ts:171` | `TransactionService.resume` |
| — | — | find | `—` | `subdomains/supporting/payment/services/transaction.service.ts:181` | `TransactionService.resume` |
| — | — | find | `—` | `subdomains/supporting/payment/services/transaction.service.ts:188` | `TransactionService.resume` |
| — | — | find | `—` | `subdomains/supporting/payment/services/transaction.service.ts:498` | `TransactionService.getAllTransactionsForUserData` |
