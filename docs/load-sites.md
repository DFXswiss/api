...
Every place in the code that reads from the database: **at most 1174 load sites** across 251 files — an upper bound, for the reason given under *Measurements*.
...
| --------- | ----: | --------------- | ---------------- |
| `find` family | 1021 | **applied** — expanded recursively | all columns of the entity plus every eager relation |
...
- 373 could not be measured: no resolvable target entity, or raw SQL.

**That last group is also why the total is an upper bound.** The collection matches `find` by name, and `find` on a repository is indistinguishable by name from `find` on an array. Where the target entity resolved, the distinction is settled; where it did not, the group holds both. A sample of 30 of those rows, read in the source, came out at 21 array operations to 9 genuine repository reads. That group holds 354 rows, so on the order of 240 of them are not database reads at all, and the true count is nearer 900.
...
| 1033 | 40 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:207` | `BuyFiatService.update` |
...
| 803 | 29 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:470` | `BuyFiatService.refundBuyFiat` |
...
| 644 | 22 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:444` | `BuyFiatService.getBuyFiat` |
| 644 | 22 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:448` | `BuyFiatService.triggerWebhookManual` |
...
| 623 | 20 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:798` | `BuyFiatService.getAllUserTransactions` |
...
| 577 | 18 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:132` | `BuyFiatService.checkAmlResetTx` |
| 577 | 18 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:601` | `BuyFiatService.resetAmlCheck` |
...
| 540 | 17 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:942` | `BuyFiatService.getByAmlReason` |
...
| 518 | 16 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:956` | `BuyFiatService.getPendingChargebacks` |
...
| 517 | 16 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:614` | `BuyFiatService.retriggerScorechain` |
...
| 392 | 14 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:818` | `BuyFiatService.getPendingTransactions` |
...
| 321 | 8 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:432` | `BuyFiatService.getBuyFiatByTransactionId` |
| 321 | 8 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:437` | `BuyFiatService.getBuyFiatsByTransactionIds` |
...
| 287 | 8 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:925` | `BuyFiatService.getTransactions` |
...
| 247 | 9 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:754` | `BuyFiatService.updateVolumes` |
...
| 201 | 5 | find | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:727` | `BuyFiatService.manualPassAmlCheck` |
...
| 144 | 6 | find | `Sell` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:843` | `BuyFiatService.getSell` |
...
| 71 | 0 | query-builder (alias only) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:410` | `BuyFiatService.getBuyFiatByKey` |
...
| 3 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:857` | `BuyFiatService.updateSellVolume` |
...
| 2 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:900` | `BuyFiatService.getRefVolume` |
| 2 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:912` | `BuyFiatService.getPartnerFeeRefVolume` |
...
| 1 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:765` | `BuyFiatService.updateRefVolumes` |
| 1 | 0 | query-builder (named columns) | `BuyFiat` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:782` | `BuyFiatService.getUserVolume` |
...
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:232` | `BuyFiatService.update` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:347` | `BuyFiatService.triggerBuyFiatReturn` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:355` | `BuyFiatService.triggerBuyFiatReturn` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:512` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:520` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:528` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:536` | `BuyFiatService.refundBuyFiatInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:645` | `BuyFiatService.resetAmlCheckInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:653` | `BuyFiatService.resetAmlCheckInternal` |
| — | — | find | `—` | `subdomains/core/sell-crypto/process/services/buy-fiat.service.ts:661` | `BuyFiatService.resetAmlCheckInternal` |
...
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:352` | `PayInService.retryUncertainSend` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:406` | `PayInService.updateFailedPayments` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:446` | `PayInService.forwardPayIns` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:492` | `PayInService.getUnconfirmedNextBlockPayIns` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:529` | `PayInService.checkOutputConfirmations` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:552` | `PayInService.checkReturnConfirmations` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:575` | `PayInService.returnPayIns` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:604` | `PayInService.processStrandedSendingPayIns` |
| — | — | find | `—` | `subdomains/supporting/payin/services/payin.service.ts:648` | `PayInService.checkInputConfirmations` |
