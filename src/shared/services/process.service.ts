...
export enum Process {
  ...
  FIAT_OUTPUT_FIAT_REPUBLIC_TRANSMISSION = 'FiatOutputFiatRepublicTransmission',
  FIAT_OUTPUT_FIAT_REPUBLIC_STATUS_CHECK = 'FiatOutputFiatRepublicStatusCheck',
  BANK_TX_FIAT_REPUBLIC_SYNC = 'BankTxFiatRepublicSync',
  VIRTUAL_IBAN_FRICK_ISSUANCE_RECONCILIATION = 'VirtualIbanFrickIssuanceReconciliation',
