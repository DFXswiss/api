...
// carry counters only, never PII (established convention). All other logging (queries, schema builds,
// migrations, level 'log') keeps its env-driven behaviour verbatim through the inherited
// AdvancedConsoleLogger methods, which is why this receives the SQL_LOGGING options.
