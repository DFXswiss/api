...
export class PrepareStrategiesFacade {
  ...
  constructor(deFiChainStrategy: DeFiChainStrategy, ethereumStrategy: EthereumStrategy, bscStrategy: BscStrategy) {
  ...
  private getAlias(asset: Asset): Alias {
    ...
    if (blockchain === Blockchain.DEFICHAIN || blockchain === Blockchain.BITCOIN) return Alias.DEFICHAIN;
  }
}
