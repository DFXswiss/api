...
@Module({
  ...
  controllers: [PaymentController, BatchController, FiatInputController, BankController],
  providers: [PaymentService, BatchService, CryptoInputService, FiatInputService, BankService],
