...
export abstract class ZanoBaseService extends BlockchainService implements OnModuleInit {
  private readonly client: ZanoClient;

  private depositService: DepositService;

  constructor(readonly moduleRef: ModuleRef, readonly http: HttpService, readonly walletUrl: string) {
    super();

    this.client = new ZanoClient(this.http, walletUrl);
  }
