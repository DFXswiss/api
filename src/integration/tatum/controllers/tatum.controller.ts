...
export class TatumController {
  ...
  constructor(readonly loggerFactory: LoggerFactory, private readonly tatumWebhookService: TatumWebhookService) {
    this.logger = loggerFactory.create(TatumController);
  }
