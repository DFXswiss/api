  ...
  formats = {
    address:
      this.environment === 'prd'
        ? /^(8\w{33}|d\w{33}|d\w{41}|0x\w{40}|(bc1|[13])[a-zA-HJ-NP-Z0-9]{25,39}|LN[A-Z0-9]{100}|ln[a-z0-9]{105})$/
        : /^((7|8)\w{33}|(t|d)\w{33}|(t|d)\w{41}|0x\w{40}|(bc1|[13])[a-zA-HJ-NP-Z0-9]{25,39}|stake[a-z0-9]{54}|LN[A-Z0-9]{100}|ln[a-z0-9]{105})$/,
