...
export enum Process {
  ...
  CRYPTO_PAY_IN_CONVERT_TOKEN = 'CryptoPayInConvertToken',
  CRYPTO_PAY_IN_FEE = 'CryptoPayInFee',
  CRYPTO_PAY_IN_CHECK = 'CryptoPayInCheck',
  ...
  TRANSACTION_SPECIFICATION = 'TransactionSpecification',
  BUY_RESET_ANNUAL = 'BuyResetAnnual',
  SELL_RESET_ANNUAL = 'SellResetAnnual',
  CRYPTO_RESET_ANNUAL = 'CryptoResetAnnual',
  USER_RESET_ANNUAL = 'UserResetAnnual',
  USER_DATA_RESET_ANNUAL = 'UserDataResetAnnual',
  LIQUIDITY_MANAGEMENT_PIPELINE = 'LiquidityManagementPipeline',
  LIQUIDITY_MANAGEMENT_ORDERS = 'LiquidityManagementOrders',
  LIQUIDITY_MANAGEMENT_REACTIVATE_RULES = 'LiquidityManagementReactivateRules',
  LIQUIDITY_MANAGEMENT_VERIFY_RULES = 'LiquidityManagementVerifyRules',
  LIQUIDITY_ORDERS_COMPLETE = 'LiquidityOrdersComplete',
  LIQUIDITY_ORDERS_FINALIZE = 'LiquidityOrdersFinalize',
  BANK_TX_OBSERVER = 'BankTxObserver',
  EXTERNAL_SERVICES_OBSERVER = 'ExternalServicesObserver',
  NODE_BALANCE_OBSERVER = 'NodeBalanceObserver',
  NODE_HEALTH_OBSERVER = 'NodeHealthObserver',
  PAYMENT_OBSERVER = 'PaymentObserver',
  USER_OBSERVER = 'UserObserver',
  REF_CHECK = 'RefCheck',
  FIAT_OUTPUTS_ADD = 'FiatOutputsAdd',
  UPDATE_CFP = 'UpdateCfp',
  UPDATE_STATISTIC = 'UpdateStatistic',
  CHECK_CHALLENGE = 'CheckChallenge',
  KYC_CHECK = 'KycCheck',
  KYC_SYNC = 'KycSync',
  KYC_DAILY_SYNC = 'KycDailySync',
  BANK_ACCOUNT_CHECK = 'BankAccountCheck',
  BANK_TX_CHECK = 'BankTxCheck',
  PURCHASE_POOL_PAIR_LIQUIDITY = 'PurchasePoolPairLiquidity',
}
