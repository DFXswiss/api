...
export class TransactionDtoMapper {
  static mapBuyCryptoTransaction(buyCrypto: BuyCrypto): TransactionDto {
    const dto: TransactionDto = {
      ...
      exchangeRate: buyCrypto.outputAmount ? buyCrypto.exchangeRate.exchangeRate : null,
      rate: buyCrypto.outputAmount ? buyCrypto.exchangeRate.rate : null,
  ...
  static mapBuyFiatTransaction(buyFiat: BuyFiat): TransactionDto {
    const dto: TransactionDto = {
      ...
      exchangeRate: buyFiat.outputAmount ? buyFiat.exchangeRate.exchangeRate : null,
      rate: buyFiat.outputAmount ? buyFiat.exchangeRate.rate : null,
