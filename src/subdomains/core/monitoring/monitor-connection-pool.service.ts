...
export class MonitorConnectionPoolService {
  ...
  @DfxCron(CronExpression.EVERY_SECOND, { perInstance: true, process: Process.MONITOR_CONNECTION_POOL })
  ...
  @DfxCron(CronExpression.EVERY_10_SECONDS, { perInstance: true, process: Process.MONITOR_CONNECTION_POOL })
