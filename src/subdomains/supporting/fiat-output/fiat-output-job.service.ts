...
import { FiatOutput, FiatOutputType, TransactionCharge } from './fiat-output.entity';
...
export class FiatOutputJobService {
  ...
  async fillFiatOutput() {
    ...
    await this.transmitFrickPayments();
  ...
  private async transmitFrickPayments(): Promise<void> {
