          ...
          'ep2:RAFDet': {
            'ep2:bdrecdet': entity.buyFiats.map((bf) => {
              const tx: Ep2Transaction = {
                ...
                'ep2:AmtFee': this.ep2Amount(bf.outputReferenceAmount - bf.outputAmount),
                'ep2:AmtFeeCurrC': bf.outputAsset.name,
                'ep2:AmtSettlement': this.ep2Amount(bf.outputReferenceAmount),
                'ep2:AmtSettlementCurrC': bf.outputAsset.name,
                'ep2:AID': 'Crypto',
                ...
                'ep2:TrxAmt': this.ep2Amount(bf.outputReferenceAmount),
                'ep2:TrxCurrC': bf.outputAsset.name,
