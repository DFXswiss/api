...
@Injectable()
export class IcpTokenStrategy extends SellLiquidityStrategy {
  protected readonly logger = new DfxLogger(IcpTokenStrategy);
  ...
  sellLiquidity(): Promise<void> {
    throw new Error('Selling liquidity on DEX is not supported for InternetComputer token');
  }
