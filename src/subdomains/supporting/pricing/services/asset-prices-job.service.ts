...
@Injectable()
export class AssetPricesJobService {
  private readonly logger = new DfxLogger(AssetPricesJobService);
  ...
  // --- HELPER METHODS --- //
  private async saveAssetPrices(asset: Asset): Promise<void> {
  ...
  private calculateMeanPrice(todayPrice: number, price: number): number {
