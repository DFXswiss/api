...
import { FeeDirectionType, User } from '../user.entity';
...
describe('User', () => {
  ...
  it('should return personal tier0 buy fee', async () => {
    ...
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER0 } as Asset)).toStrictEqual(0);
  });

  // tier 0 sell
  it('should return personal tier0 sell fee', async () => {
    const user = setup(AccountType.PERSONAL);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER0 } as Asset)).toStrictEqual(0);
  });

  // tier 1 buy
  it('should return personal tier1 buy fee', async () => {
    const user = setup(AccountType.PERSONAL);
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER1 } as Asset)).toStrictEqual(0.0099);
  });

  it('should return business tier1 buy fee', async () => {
    const user = setup(AccountType.BUSINESS);
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER1 } as Asset)).toStrictEqual(0.0149);
  });
  ...
  it('should return personal tier1 sell fee', async () => {
    const user = setup(AccountType.PERSONAL);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER1 } as Asset)).toStrictEqual(0.0149);
  });

  it('should return business tier1 sell fee', async () => {
    const user = setup(AccountType.BUSINESS);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER1 } as Asset)).toStrictEqual(0.0199);
  });
  ...
  it('should return personal tier2 buy fee', async () => {
    const user = setup(AccountType.PERSONAL);
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER2 } as Asset)).toStrictEqual(0.0149);
  });

  it('should return business tier2 buy fee', async () => {
    const user = setup(AccountType.BUSINESS);
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER2 } as Asset)).toStrictEqual(0.0199);
  });
  ...
  it('should return personal tier2 sell fee', async () => {
    const user = setup(AccountType.PERSONAL);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER2 } as Asset)).toStrictEqual(0.0199);
  });

  it('should return business tier2 sell fee', async () => {
    const user = setup(AccountType.BUSINESS);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER2 } as Asset)).toStrictEqual(0.0249);
  });
  ...
  it('should return personal tier3 buy fee', async () => {
    const user = setup(AccountType.PERSONAL);
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER3 } as Asset)).toStrictEqual(0.0225);
  });

  it('should return business tier3 buy fee', async () => {
    const user = setup(AccountType.BUSINESS);
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER3 } as Asset)).toStrictEqual(0.0275);
  });
  ...
  it('should return personal tier3 sell fee', async () => {
    const user = setup(AccountType.PERSONAL);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER3 } as Asset)).toStrictEqual(0.0275);
  });

  it('should return business tier3 sell fee', async () => {
    const user = setup(AccountType.BUSINESS);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER3 } as Asset)).toStrictEqual(0.0325);
  });
  ...
  it('should return personal tier4 buy fee', async () => {
    const user = setup(AccountType.PERSONAL);
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER4 } as Asset)).toStrictEqual(0.0299);
  });

  it('should return business tier4 buy fee', async () => {
    const user = setup(AccountType.BUSINESS);
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER4 } as Asset)).toStrictEqual(0.0349);
  });
  ...
  it('should return personal tier4 sell fee', async () => {
    const user = setup(AccountType.PERSONAL);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER4 } as Asset)).toStrictEqual(0.0349);
  });

  it('should return business tier4 sell fee', async () => {
    const user = setup(AccountType.BUSINESS);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER4 } as Asset)).toStrictEqual(0.0399);
  });
  ...
  it('should return 0.005 when individual fee 0.005', async () => {
    ...
    expect(user.getFee(FeeDirectionType.BUY, { feeTier: FeeTier.TIER1 } as Asset)).toStrictEqual(0.005);
  });

  it('should return 0.005 when individual fee 0.005', async () => {
    const user = setup(AccountType.PERSONAL, undefined, undefined, undefined, 0.005);
    expect(user.getFee(FeeDirectionType.SELL, { feeTier: FeeTier.TIER1 } as Asset)).toStrictEqual(0.005);
  });
