...
export const DebugBlockedCols: Record<string, string[]> = {
  ...
  buy_crypto: ['recipientMail', 'chargebackIban', 'chargebackRemittanceInfo', 'siftResponse', 'chargebackCreditorData'],
  ...
  buy: ['iban'],
  deposit_route: ['iban'],
  bank_tx_return: ['chargebackIban', 'recipientMail', 'chargebackRemittanceInfo', 'chargebackCreditorData'],
