...
export class KycInfoMapper {
  static toDto(userData: UserData, withSession: false): KycStatusDto;
  static toDto(userData: UserData, withSession: true): KycSessionDto;

  static toDto(userData: UserData, withSession: boolean): KycStatusDto | KycSessionDto {
