...
# "jdmp": JuiceDollar Testnet Ponder
# "jdma": JuiceDollar Testnet API
# "jdmd": JuiceDollar Testnet dApp
appNameOptions=("fcp" "dep" "dea" "ded" "dem" "jsp" "jsw" "n8n" "jdtp" "jdta" "jdtd" "jdtm" "jdmp" "jdma" "jdmd")
